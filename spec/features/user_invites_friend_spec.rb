...
feature 'User invites friend' do
	...
	def invite_a_friend
		...
		fill_in "Friend's Name", with: "john@example.com"
		fill_in "Friend's Email Address", with: "jhon@example.com"
	...
	def friend_signs_in
		fill_in "Email Address", with: "jhon@example.com"
		fill_in "Password", with: "password"
